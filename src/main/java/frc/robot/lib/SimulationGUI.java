...
public class SimulationGUI extends JPanel implements ActionListener {
	...
	public SimulationGUI(double joystickX, double joystickY) {
		...
		frame = new JFrame("4536 FRC SimulatorGUI");
	...
	public void newMeccanumBot(Graphics2D g) {
		...
		int[] chassis_cords  = {-75, -100, 150 + robotX, 200 + robotY}; //{-75, -100, 150, 200}
		int[] upperRightWheel_cords = {75, -100, 25 + robotX, 60 + robotY}; //{75, -100, 25, 60}
		int[] lowerRightWheel_cords = {75, 40, 25 + robotX, 60 + robotY}; //{75, 40, 25, 60}
		int[] upperLeftWheel_cords = {-100, -100, 25 + robotX, 60 + robotY}; //{-100, -100, 25, 60}
		int[] lowerLeftWheel_cords = {-100, 40, 25 + robotX, 60 + robotY}; //{-100, 40, 25, 60}
